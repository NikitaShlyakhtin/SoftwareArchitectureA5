...
func newMessagesTableImpl(schemaName, tableName, alias string) messagesTable {
	var (
		...
		IsLikedColumn  = postgres.BoolColumn("is_liked")
		allColumns     = postgres.ColumnList{IDColumn, UsernameColumn, ContentColumn, IsLikedColumn}
		mutableColumns = postgres.ColumnList{UsernameColumn, ContentColumn, IsLikedColumn}
	)
